...
// idf.py menuconfig allows you to define what the device is.
// In this case it is defined as an end device.
...
// Defining the button that toggles the switch and the control it is connected to, as a pair
